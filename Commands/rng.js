...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addNumberOption((option) =>
      option.setName('min').setDescription('the minimum number - Default: 0')
    )
    .addNumberOption((option) =>
      option.setName('max').setDescription('the minimum number - Default: 100 greater than min')
    )
    .addBooleanOption((option) =>
      option
        .setName('spoiler')
        .setDescription('if true, the number message be hidden - Default: false')
    ),
  /**
